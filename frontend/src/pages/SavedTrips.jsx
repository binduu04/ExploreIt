...
// // //   Clock, DollarSign, Share2, Bookmark, Plane, SortAsc,SortDesc, MoreVertical, Edit, Copy, Archive, MessageCircle
// // // } from 'lucide-react'
...
//       {/* Chat Sidebar - Fixed positioning on the right */}
//       {selectedTripForChat && (
//         <div className={`fixed top-0 right-0 h-full w-96 bg-white shadow-2xl border-l border-gray-200 transform transition-transform duration-300 z-50 ${
